...
<template>
  <div class="p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700 flex flex-col shadow-sm">
    ...
    <div class="flex items-center gap-2 flex-wrap">
      ...
      <router-link v-if="isMentor" :to="{ name: 'editor', params: { id: tree.id } }" class="px-4 py-2 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition text-sm font-medium">
        {{ t('edit') }}
      </router-link>
